...
if __name__ == "__main__":
    ...
    layers_act_adv,distribution_adv,layers_act_std_adv,layer_dims_adv=extract_ben_dist(model,X_adv_train,Y_test,layer_dims,sample_bal=X_train_sample_bal[dataset])
